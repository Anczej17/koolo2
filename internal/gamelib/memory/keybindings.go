...
func (gd *GameReader) GetKeyBindings() data.KeyBindings {
	blob := gd.reader.ReadBytesFromMemory(gd.moduleBaseAddressPtr+gd.offset.KeyBindingsOffset, 0x500)
	blobSkills := gd.reader.ReadBytesFromMemory(gd.moduleBaseAddressPtr+gd.offset.KeyBindingsSkillsOffset, 0x500)
